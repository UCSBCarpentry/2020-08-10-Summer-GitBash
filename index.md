...
language: "us"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the
latitude: "45"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-1"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "August 11-12, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
eventbrite for Bash: 112890793402           # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
eventbrite for Git: 112891367118
---
